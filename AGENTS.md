...
- Run `python scripts/bootstrap_validate.py` before committing until the indexed complete schema and manifest tooling lands. Once present, run the complete validator and manifest check as well.
