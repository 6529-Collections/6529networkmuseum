...
from generate_public_publication_inventory import _active_media_repository_paths, generate  # noqa: E402
...
class PublicationInventoryRightsTests(unittest.TestCase):
    ...
    def test_keys_and_gates_unknown_rights_derivatives_are_not_visitor_assets(self) -> None:
        ...
        self.assertFalse(any(path.startswith("media/programs/6529NM-AP-01/") for path in media_paths))
        self.assertNotIn(
