...
def build_records(
    ...
    *,
    ...
    add_entity(magnum_org, "ORGANIZATION", "Magnum Photos", slug_inventory[magnum_org]["public_slug"], slug_inventory[magnum_org]["canonical_route"], PROPOSAL_AT, {
        ...
        "authority": {"authority_status": "provisional", "authority_record_ids": [], "evidence_refs": [source_evidence("Magnum Photos research profile", "records/proposed-gifts/6529NM-PG-2026-001/public/scholarship/entities/magnum-photos.md", MAGNUM_PUBLICATION_AT)]}, "name_variants": names("Magnum Photos", "published_source", ["records/proposed-gifts/6529NM-PG-2026-001/public/scholarship/entities/magnum-photos.md"], MAGNUM_PUBLICATION_AT),
    }, ["6529NM-PG-2026-001"], [source_evidence("Magnum Photos research profile", "records/proposed-gifts/6529NM-PG-2026-001/public/scholarship/entities/magnum-photos.md", MAGNUM_PUBLICATION_AT)])
    ...
    for obj in proposal["objects"]:
        ...
        add_entity(artist_id, "ARTIST", obj["artist"], slug_inventory[artist_id]["public_slug"], slug_inventory[artist_id]["canonical_route"], PROPOSAL_AT, {
            "profile_type": "ARTIST", "authority": {"authority_status": "provisional", "authority_record_ids": [agent_id], "evidence_refs": [source_evidence("Museum artist research profile", artist_publication["path"], MAGNUM_PUBLICATION_AT)]}, "practice": {"summary": artist_publication["summary"], "areas": artist_publication["areas"], "evidence_refs": [source_evidence("Museum artist research profile", artist_publication["path"], MAGNUM_PUBLICATION_AT)]}, "name_variants": names_with_source_label(obj["artist"], "proposal", ["6529NM-PG-2026-001"], PROPOSAL_AT),
        }, [agent_id, "6529NM-PG-2026-001", candidate_id], [source_evidence("Museum artist research profile", artist_publication["path"], MAGNUM_PUBLICATION_AT)])
    ...
    add_entity(magnum_publication, "RESEARCH_PUBLICATION", "Conflict at Its Edges", "conflict-at-its-edges", "/museum/network/research/conflict-at-its-edges", MAGNUM_PUBLICATION_AT, {
        "profile_type": "RESEARCH_PUBLICATION", "publication_kind": "catalogue_essay", "title": "Conflict at Its Edges", "publication_date": "2026-08-09", "version": "1.0.0", "author_entity_ids": [institution], "subject_entity_ids": ["6529NM-CA-2026-003", magnum_org, magnum_project, *magnum_artist_ids, *magnum_works], "publication_document_uri": github_uri(magnum_essay_path), "evidence_refs": [source_evidence("Conflict at Its Edges Research Publication", magnum_essay_path, MAGNUM_PUBLICATION_AT)],
    }, ["6529NM-PG-2026-001", "6529NM-CA-2026-003", magnum_org, magnum_project, *magnum_artist_ids, *magnum_works], [source_evidence("Conflict at Its Edges Research Publication", magnum_essay_path, MAGNUM_PUBLICATION_AT)])
    ...
    for target in ["6529NM-CA-2026-003", magnum_org, magnum_project, *magnum_artist_ids, *magnum_works]:
        add_relation(f"6529NM-REL-{relation_number:04d}", "PUBLICATION_INTERPRETS_ENTITY", magnum_publication, target, {"role": "subject"}, MAGNUM_PUBLICATION_AT, ["6529NM-PG-2026-001", target], [source_evidence("Conflict at Its Edges Research Publication", magnum_essay_path, MAGNUM_PUBLICATION_AT)]); relation_number += 1
    add_relation(f"6529NM-REL-{relation_number:04d}", "INSTITUTION_PUBLISHES_PUBLICATION", institution, magnum_publication, {}, MAGNUM_PUBLICATION_AT, ["6529NM-PG-2026-001", magnum_publication], [source_evidence("Conflict at Its Edges Research Publication", magnum_essay_path, MAGNUM_PUBLICATION_AT)]); relation_number += 1
