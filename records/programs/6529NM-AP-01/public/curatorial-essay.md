...
The two silhouettes in [*No Key, Only Light*](works/no-key-only-light.md) occupy a rough passage at Fort Frederick. Their path narrows through stone and ends in white glare. Personal movement and the fort’s histories of defence and surveillance meet at that blown-out opening; facial detail is absent from the frame. The artist’s account supplies the family and pandemic-travel narrative, while public site history supplies the architectural frame. The distinction matters: the image can carry the force of a return, while the attributed account remains distinct from verified biography.[^1]
...
Veerendra’s [*No Access*](works/no-access.md) builds the barrier by hand. A white house and red roof sit beneath a starry sky; a path ends at a lit gate and warning sign. Focus stacking keeps the miniature scene unusually legible, allowing the viewer to inspect every part of the distance while the figure remains outside. Scale is the work’s pressure point: shelter is close enough to see, and permission is still a small sign across the path.
...
[^1]: Fort Frederick’s public architectural history and the distinction between site context and the artist’s account are recorded in the [context register](contexts/index.md#fort-frederick-grenada-out-004). The family narrative, date discrepancy, and consent representation remain attributed to the submission.
[^2]: Parks Canada, [Visiting Lake Louise and Moraine Lake](https://parks.canada.ca/pn-np/ab/banff/visit/parkbus/louise), accessed 8 August 2026; the [Moraine Lake context entry](contexts/index.md#moraine-lake-access-out-007) keeps the official access policy separate from the artist’s 2024 capture conditions.
...
[^5]: The visual description, 640-only delivery rule, and document-legibility boundary are recorded in the [media join](media-joins.md#out-011), [rights register](rights-and-consent.md#display-specific-ethical-basis), and [OUT-011 delivery amendment](accessibility-amendment-2026-08-08-004.md).
