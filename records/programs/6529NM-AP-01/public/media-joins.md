...
| <a id="out-002"></a>OUT-002 | `sha256:e3d4f538d4c9d3aa79a1d7ed11e93819a806fad85dbed4b8b38e9c62528d55fe` | 6000 × 4000 | An elevated view shows blurred traffic around a sharply defined performer in a white tub or boat. | 640 × 427 · `sha256:fc6d063c…f3a38` | 1280 × 853 · `sha256:3d67ee66…8425` | 2400 × 1600 · `sha256:27be835c…b5269` |
...
| <a id="out-011"></a>OUT-011 | `sha256:4d7c6e452638a6dd091253bf1cc2c5b14e141920dd72a28dab5085bb7b4526fc` | 6000 × 4000 | A nude figure reclines on an ornate gold chair, holding a dark booklet or document. | 640 × 427 · `sha256:14eea875…fc784` | 1280 × 853 · `sha256:00f3ff73…6f985` | 2400 × 1600 · `sha256:c704956b…2c251` |
...
| <a id="out-016"></a>OUT-016 | `sha256:6f2e18606cc3fc4c3af0fadb3a275ef0a739c00463481bfb5fa511be238f5b73` | 4896 × 3917 | A miniature white house with a red roof sits beyond a gate on a hill beneath a night sky. | 640 × 512 · `sha256:3e67afb1…a65f` | 1280 × 1024 · `sha256:057c4077…f4996` | 2400 × 1920 · `sha256:24271a75…83a9f` |
...
All sixteen current manifest descriptions are marked `constructed_visual_description_pending_independent_review`. The four 640px derivatives OUT-001–004 and OUT-005–016 were visually inspected during this corpus build. The current descriptions are broadly accurate, with these editorial notes:

| Outcome | Editorial note |
|---|---|
| OUT-002 | Add the sharply legible performer in a white tub/boat; the current text foregrounds buses and omits the work’s central visual contrast. |
| OUT-004 | Keep “silhouetted figures” until age and consent are confirmed; the artist calls them children, but the public alt text should not make a sensitive identity assertion prematurely. |
| OUT-008 | The current description is accurate and avoids the unverified prison identification. |
| OUT-009 | The current description captures the industrial façade and slogan; it avoids assigning graffiti authorship. |
| OUT-010 | The current description accurately describes visible torso and fabric; retain a content notice in presentation context. |
| OUT-011 | Use “dark booklet/document” rather than “passport” in neutral alt text until the subject approves document identification; the statement identifies it as a passport, but visible sensitive details should not be amplified. |
| OUT-013 | The current description accurately says “beside a small insect”; retain that wording rather than the artist’s “inside the key” metaphor. |
| OUT-015 | The current description identifies the orange head covering and train windows without naming the women or the historical poster. |
| OUT-016 | The current description is accurate; the warning sign and silhouette are useful details but should be added only after the artist confirms the miniature/figure status. |

These are editorial recommendations. The existing accessibility JSON and media manifest remain unchanged in this WP-4 content pass; any technical amendment must use the media-control workflow.
