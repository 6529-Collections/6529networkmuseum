...
- [Conflict at Its Edges: acquisition profile](entities/conflict-at-its-edges.md)
- [Conflict at Its Edges: catalogue essay](essays/conflict-at-its-edges.md)
- [Acquisition narrative](essays/acquisition-narrative.md)

The catalogue essay considers the group as an argument in documentary form.
It follows the unstable boundary between an event and its evidence: where
political force enters ordinary space, what a photograph can establish, and
...
| Date | Artist | Work |
| --- | --- | --- |
| 1952 | [David Seymour](artists/david-seymour.md) | [*Patrolling the border between the Negev Desert and Jordan*](works/01-david-seymour-127.md) |
| 1986 | [Larry Towell](artists/larry-towell.md) | [*Government soldiers in a church, Suchitoto, El Salvador*](works/02-larry-towell-145.md) |
| 1989 | [Micha Bar-Am](artists/micha-bar-am.md) | [*Demonstration, Western Wall, Jerusalem*](works/03-micha-bar-am-97.md) |
| 2011 | [Moisés Saman](artists/moises-saman.md) | [*Tripoli, Libya*](works/04-moises-saman-44.md) |
| 2016 | [Lorenzo Meloni](artists/lorenzo-meloni.md) | [*Palmyra, Syria*](works/05-lorenzo-meloni-104.md) |
...
- [Magnum Photos](entities/magnum-photos.md)
- [Magnum Photos 75](entities/magnum-photos-75.md)

Magnum Photos is the photographer-owned cooperative founded in 1947. Magnum
Photos 75 was an anniversary publishing project in 2022 that placed works from
the archive in a tokenized setting. Neither entity is the Museum acquisition.
The acquisition consists of the five independent works listed above, brought
together under a new curatorial thesis.

## Research record

- [Chronologies](dossiers/chronologies.md)
- [Caption and evidence dossier](dossiers/caption-evidence.md)
- [Source and rights record](dossiers/source-and-rights-record.md)
- [Rights, technical, and provenance dossier](dossiers/rights-technical-provenance.md)
- [Media plan](dossiers/media-plan.md)
- [Source register](sources/source-register.md)

The research distinguishes direct chain observation, issuer and institutional
records, Museum technical examination, historical sources, and curatorial
interpretation. Captions remain attributed to their publishers unless
independently established. Unresolved archive references and variations remain
visible in the dossiers.
