...
| 23 August 2026 | The Museum reads back and retains the Wave API’s `WINNER` status. The same response reports `is_signed: true`; no separate cryptographic signature evidence is asserted. |
...
The source package at `evidence/vera-molnar-210-sources` retains the four-part Wave publication, the Art Blocks metadata response, the official PNG preview, and their fixity. Its manifest SHA-256 is `71fb6066e1113e22c8586e195bfb8d553dcc8c4d7dec5b33de3ae47d3ebcafe5`.
