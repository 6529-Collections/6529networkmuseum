...
The transfer was evidence of delivery, not by itself an accession decision. Wallet custody can result from a gift, loan, mistaken transfer, airdrop, or operational movement. The Museum separately documented donor authority, title, rights, provenance, technical condition, and the basis for acceptance. It formally accepted punk6529's full gift effective at 22:55 UTC on 1 August and accessioned the seven works into the permanent collection on 2 August 2026.[^2]
...
That separation is especially important for digital art. A token can carry unique chain identity and ownership history while the work's images, code, and presentation remain governed by copyright and license. The retained metadata for all seven works states CC BY-NC 4.0. Subject to its conditions, that license supports the Museum's noncommercial exhibition, publication, documentation, adaptation, preservation, migration or emulation, accessibility work, and internal noncommercial computational research. Commercial use is not approved.[^4]
