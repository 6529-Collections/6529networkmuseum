...
| [`notes/wip/2026-08-04-generative-system-frontend-experience.md`](notes/wip/2026-08-04-generative-system-frontend-experience.md) | release candidate with amended display boundary | Project-owned Inside the System route, five Casey-specific visualizers, complete minted lookup/filter indexes, side-by-side Museum models, reviewed descriptor-backed suggestions, accession deep links, and the versioned derived-display boundary; optional atomic remote study records remain future work rather than a v1 display blocker |
