...
| [`notes/wip/2026-08-08-wp-3-magnum-scholarship.md`](notes/wip/2026-08-08-wp-3-magnum-scholarship.md) | active WP-3 scholarship and integration handoff | Isolated Magnum entity/artist/Work corpus bound to the WP-1 target IDs, source/date corrections, selected-review status boundary, proposal-media safeguards, UTF-8/link/editorial checks, and typed admission checkpoint |
