...
| [`records/institutional-practice/a-field-of-practice.md`](records/institutional-practice/a-field-of-practice.md) | public comparative essay | Second-edition work-led study of collecting, presenting, and caring for digital art, with selection method, thematic pathways, working lessons, and grouped case files |
...
| [`records/institutional-practice/source-register.md`](records/institutional-practice/source-register.md) | public research apparatus | Detailed first-edition register and second-edition source-apparatus explanation |
...
| [`notes/wip/2026-08-04-institutional-practice-second-edition.md`](notes/wip/2026-08-04-institutional-practice-second-edition.md) | active research and publication ledger | Digital-weighted second-edition mandate, six parallel research lanes, fixed editorial requirements, baseline, decisions, and release boundary |
...
| [`notes/research/institutional-practice-second-edition-synthesis.md`](notes/research/institutional-practice-second-edition-synthesis.md) | reviewed research input | Twenty-seven-profile field, digital-first selection, chain-native category boundaries, stewardship requirements, scholarship principles, website judgment, and exclusions |
