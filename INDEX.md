...
| [`records/institutional-practice/rights-and-licenses.md`](records/institutional-practice/rights-and-licenses.md) | public educational handbook | Copyright and public-domain foundations, token/work distinction, Creative Commons family, cultural-heritage rights statements, no-license cases, and practical reading route |
...
| [`docs/rights/registry.json`](docs/rights/registry.json) | canonical public rights-expression registry | Twenty-two standard license, dedication, mark, status, no-license, and custom-term entries with official URIs, practical use matrix, Casey assignments, and conditional Keys and Gates note |
