...
| [`notes/wip/2026-08-08-wp-3-magnum-scholarship.md`](notes/wip/2026-08-08-wp-3-magnum-scholarship.md) | active WP-3 scholarship and integration handoff | Genre-separated Magnum public corpus with art-first Work pages, differentiated artist histories, selection-specific acquisition argument, selected-review status boundary, proposal-media safeguards, and typed admission checkpoint |
