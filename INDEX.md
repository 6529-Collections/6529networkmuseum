...
| [`records/institutional-practice/a-field-of-practice.md`](records/institutional-practice/a-field-of-practice.md) | public comparative essay | Why and how the Museum studies peer institutions; six demonstrated practices and six resulting commitments |
| [`records/institutional-practice/profiles/`](records/institutional-practice/profiles/) | public institutional profiles | Fourteen primary-source profiles covering collection museums, media-art institutions, research infrastructures, and network-native organizations, with specific lessons and limits |
| [`records/institutional-practice/source-register.md`](records/institutional-practice/source-register.md) | public research apparatus | Exact-title, date, source-type, access, and claim register for the institutional study |
