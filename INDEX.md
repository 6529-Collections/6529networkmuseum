...
| [`notes/wip/2026-08-08-integrated-gifts-and-acquisition-funding-policy.md`](notes/wip/2026-08-08-integrated-gifts-and-acquisition-funding-policy.md) | published replacement proposal source | Exact source for Museum Wave proposal serial 1282040 covering art-gift votes, one-time acquisition-program authorization, Approved Settlement Assets, restricted and unrestricted funding, Meme Card collaborator proceeds, non-approved assets, conversion, and unsolicited transfers |
| [`notes/wip/2026-08-08-integrated-gifts-and-acquisition-funding-publication.md`](notes/wip/2026-08-08-integrated-gifts-and-acquisition-funding-publication.md) | live replacement publication receipt | Punk6529 authorization, withdrawn-proposal boundary, signed `PARTICIPATORY` identity and URL, exact content commitment, zero-vote publication readback, and explicit not-yet-adopted status |
...
| [`scripts/generate_program_media.py`](scripts/generate_program_media.py) | deterministic media control | Generates or verifies the closed Keys and Gates WebP derivative inventory, fixity, geometry, colour profile, record joins, and immutable paths |
