...
| [`records/accessions/register.json`](records/accessions/register.json) | canonical constructed current-view register | Casey Reas seven-work gift formally accepted; completion certificate and independent documentation review remain pending |

## Casey Reas accession dossier

| File | Status | Contents |
|---|---|---|
| [`records/accessions/6529NM.2026.001/accession-statement.json`](records/accessions/6529NM.2026.001/accession-statement.json) | constructed `ACCESSION_LOT` control-plane record | Formally accepted gift, seven-object identity/receipt schedule, curatorial statement, immutable Casey evidence binding, rights boundary, preservation manifest, constructor controls, and completion gates; current state is `received_onchain`, accession is `not_complete` |
| [`records/accessions/6529NM.2026.001/gift-acceptance-authorization.json`](records/accessions/6529NM.2026.001/gift-acceptance-authorization.json) | constructed `GIFT_ACCEPTANCE_AUTHORIZATION` | Dated formal gift and accession authorization under adopted Art Blocks and donation-policy decisions; separate from the pending Stream completion certificate/title binding |
| [`records/accessions/6529NM.2026.001/visual-observation-record.json`](records/accessions/6529NM.2026.001/visual-observation-record.json) | constructed `VISUAL_OBSERVATION` | Seven-object raw-metadata/source-URL binding, static-response and full-viewport screenshot fixity, canvas geometry, timing proxies, non-retention, and explicit condition/preservation limits |
| [`records/accessions/6529NM.2026.001/rights/6529NM.2026.001.RIGHTS.01.json`](records/accessions/6529NM.2026.001/rights/6529NM.2026.001.RIGHTS.01.json) | constructed `RIGHTS_STATEMENT` | Per-object rights schedule; all use classes remain `unspecified` pending registrar instrument review; sibling files cover all seven objects |
| [`records/accessions/6529NM.2026.001/technical/6529NM.2026.001.01.json`](records/accessions/6529NM.2026.001/technical/6529NM.2026.001.01.json) | constructed `CONDITION_REPORT` | Per-object technical/condition report with direct custody evidence, observation fixity, and explicit render/preservation gates; sibling files cover all seven objects |
| [`evidence/casey-reas/manifest.json`](evidence/casey-reas/manifest.json) | content-addressed preservation evidence package | Seven retained raw metadata response byte streams plus explicit pending generator-capture status; no conservation or display completion is claimed |
...
| [`records/accessions/6529NM.2026.001/public/casey-reas-artist-practice.md`](records/accessions/6529NM.2026.001/public/casey-reas-artist-practice.md) | constructed public curatorial profile | Sourced artist biography, practice arc, pedagogy/tool-building/publishing context, and institutional exhibition/collection context |
| [`records/accessions/6529NM.2026.001/public/casey-reas-collection-essay.md`](records/accessions/6529NM.2026.001/public/casey-reas-collection-essay.md) | constructed public curatorial essay | Collection-level reading of rule, behavior, room, and cosmos with static/live documentation boundary |
| [`records/accessions/6529NM.2026.001/public/gift-acceptance-authorization.md`](records/accessions/6529NM.2026.001/public/gift-acceptance-authorization.md) | public human-readable authorization | Limited formal gift acceptance, governing basis, public donor/authority declaration limitation, and named completion blockers |
| [`records/accessions/6529NM.2026.001/accession-statement.json`](records/accessions/6529NM.2026.001/accession-statement.json) | public/restricted boundary and constructor controls | The lot record carries a public restricted-annex placeholder and constructor/reviewer controls; no instrument or deed hash is present |
...
| [`notes/wip/2026-08-01-casey-accession-working-plan.md`](notes/wip/2026-08-01-casey-accession-working-plan.md) | WIP analysis | Multi-object numbering and proposed deliverables from the supplied accession draft; PR #10 integration binds the completed descriptor package while preserving incomplete accession gates |
