...
| File | Status | Contents |
|---|---|---|
| [`records/accessions/6529NM.2026.001/accession-statement.json`](records/accessions/6529NM.2026.001/accession-statement.json) | constructed `ACCESSION_LOT` control-plane record | Formal intake/pathway statement, collection curatorial statement, seven-object identity/receipt schedule, donation/rights boundary, preservation manifest, public inventory, restricted annex stub, constructor controls, payload SHA-256, and remaining gates; current state is `received_onchain`, accession is `not_complete` |
...
| [`docs/casey-accession-control.md`](docs/casey-accession-control.md) | active accession control note | Payload-hash basis, cross-file invariants, custody/title boundary, evidence grading, preservation gates, and reviewer boundary |
