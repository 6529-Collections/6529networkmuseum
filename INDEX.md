...
| [records/programs/6529NM-AP-01/public/accessibility-amendment.md](records/programs/6529NM-AP-01/public/accessibility-amendment.md) | append-only derived publication amendment | Completed sixteen-image visual audit; exact OUT-002/011/016 accessibility corrections; reviewed status; one-to-one media/work invariant; source and rights boundary |
...
| [`scripts/generate_program_media.py`](scripts/generate_program_media.py) | deterministic media control | Generates or verifies the closed Keys and Gates WebP derivative inventory, fixity, geometry, colour profile, reviewed accessibility text, record joins, and immutable paths |
...
| [`tests/test_keys_gates_public_corpus.py`](tests/test_keys_gates_public_corpus.py) | focused editorial/media control | Exact reviewed accessibility text, sixteen-way typed/media/public Work join, visitor status, and no raw selected state on Work pages |
